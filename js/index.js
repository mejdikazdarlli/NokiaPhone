...
function onDocumentMouseMove(event) {
    ...
    if (intersects.length > 0)
        ...
        {_("MKViewer").style.cursor="pointer"}else{_("MKViewer").style.cursor="default"}
        }
}
async function onDocumentTouchClick(event) {
    ...
    if (intersects.length > 0) {
        if (intersects[0].object.name.startsWith("btn")) {
            ...
            // screenNumbers.material.map = numbers(num,"bold","normal",500,"Arial",'white','red')
            // screenNumbers.material.alphaMap = numbers(num,"bold","normal",500,"Arial",'black','white')
